  ...
  return (
    <section className="px-6 py-[72px] pb-2">
      <div className="max-w-5xl mx-auto">
        <div className="text-xs font-bold tracking-[0.2em] uppercase text-[#b98a2e]">Air-Gapped by Design</div>
        <h2 className="font-serif text-[clamp(24px,3.4vw,32px)] mt-2.5 mb-3.5">{t.agH2}</h2>
        <p className="text-[#4b564d] dark:text-[#a9b4a7] max-w-[44em]">{t.agLead}</p>
